...
void USART2_GPIOInit(void)
{
	...
	//USART2 TX
	usart_gpios.GPIO_PinConfig.GPIO_PinNumber  = GPIO_PIN_NUMBER_2;
	GPIO_Init(&usart_gpios);

	//USART2 RX
	usart_gpios.GPIO_PinConfig.GPIO_PinNumber = GPIO_PIN_NUMBER_3;
	GPIO_Init(&usart_gpios);
...
void GPIO_ButtonInit(void)
{
	...
	GPIOBtn.GPIO_PinConfig.GPIO_PinNumber = GPIO_PIN_NUMBER_0;
