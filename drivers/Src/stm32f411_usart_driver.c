...
static void USART_ClearIRQErrFlag(USART_RegDef_t *pUSARTx);
...
//Note : CTS feature is not applicable for UART4 and UART5
	...
	(void) temp3; //in this driver we current don't use it
	...
	if(temp2 )
	{
		...
		if(temp1 & ( 1 << USART_SR_NF) )
		{
			/*
				...
				USART_DR register).
			*/
			USART_ClearIRQErrFlag(pUSARTHandle->pUSARTx);
...
{
	// this is a weak function. It should overwrite by application
}
