 ...
 *      Author: shiba
 */
#include "../../externalDevicesDriver/Inc/rtc_ds1307.h"
...
static void ds1307_i2c_config(void)
{
	...
	Ds1307I2cHandle.I2C_Config.I2C_DeviceAddress = 0x61;
	Ds1307I2cHandle.I2C_Config.I2C_FMDutyCycle = I2C_FM_DUTY_2;
...
{
	uint8_t data;
	I2C_MasterSendData(&Ds1307I2cHandle, &reg_addr, 1, DS1307_I2C_ADDR, I2C_SR_DISABLE);
